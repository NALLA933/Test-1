...
class Config:
    ...
    TOKEN: str = os.getenv("BOT_TOKEN", "8551975632:AAEXxYg2vj-wBAt376nLqZxqFw-yMhU0xZo")
    ...
    SUDO_USERS: List[int] = [
        int(user_id.strip())
        for user_id in os.getenv("SUDO_USERS", "7818323042,8453236527,6024289634,8304706471,8420981179,8555362860,6831593338").split(",")
